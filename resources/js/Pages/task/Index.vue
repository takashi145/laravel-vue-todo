    ...
    <div v-if="open" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
        ...
        <div class="mx-auto mt-40 relative p-4 w-full md:max-w-3xl h-full md:h-auto">
            <div class="relative bg-gray-100 rounded shadow">
                <button type="button" @click="open = false" class="absolute top-3 right-2 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form @submit.prevent="createTask()" class="space-y-8">
                        ...
                        <div>
                          <label for="deadline" class="block mb-2 text-lg font-medium text-gray-900">Deadline</label>
                        ...
                        <div class="flex justify-around">
                          ...
                          <button type="button" @click="open = false" class="w-1/2 mx-3 text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3">Close</button>
                        </div>
                    </form>
                </div>
            </div>
      ...
      <div class="container px-5 py-12 mx-auto">
        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
          <div class="mb-3 text-right">
            <button @click="open = true" class="text-white bg-indigo-400 hover:bg-indigo-500 p-3 rounded">
