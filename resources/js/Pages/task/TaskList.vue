...
<template>
  <auth-layout :class="{'max-h-screen overflow-y-hidden': openModal || showTaskModal}">
    <div class="m-8">
      ...
      <section class="text-gray-600 body-font">
        <button @click="openModal = true" class="fixed bottom-12 right-5 text-white bg-indigo-400 hover:bg-indigo-500 p-4 rounded-full">
            ...
            <div class="lg:flex lg:mt-8">
              <div class="p-3 mb-3 mr-8 w-full lg:w-1/3">
                <form @submit.prevent="getTaskList()" class="shadow-lg p-8 border rounded">
                  ...
                  <div>
                    <button type="submit" class="text-white bg-indigo-400 hover:bg-indigo-500 p-3 rounded-lg">検索</button>
                  </div>
                </form>
              </div>
              ...
              <div :class="{'relative': isLoading}" class="w-full lg:w-2/3">
                <div v-if="isLoading">
                  <div class="absolute fixed inset-0 bg-black opacity-10"></div>
                  <div class="flex justify-center">
                    <div class="absolute fixed top-60 animate-spin h-16 w-16 border-8 border-t-transparent border-white rounded-full"></div>
                  </div>
                </div>
